...
#define INTEGRAL_NAME doublebox_nonplanar_integral
#define doublebox_nonplanar_integral_number_of_sectors 18

// whether or not to use contour deformation
#define integral_contour_deformation 1

// whether or not complex parameters are present
#define integral_has_complex_parameters 0

// whether or not the return type should be complex in any case
#define integral_enforce_complex_return_type 0
...
// delegate some template instantiations to separate translation units
    ...
    #define EXTERN_SIDI_QMC_SEPARATE(SIDIDEGREE) \
        ...
        extern template class secdecutil::integrators::Qmc< \
                                                               ...
                                                               ::integrators::fitfunctions::PolySingular::type \
                                                          >;
    #if doublebox_nonplanar_integral_number_of_sectors != 1
...
#undef doublebox_nonplanar_integral_number_of_sectors
