#ifndef doublebox_planar_hpp_included
#define doublebox_planar_hpp_included
...
namespace doublebox_planar
{
    ...
    #define doublebox_planar_contour_deformation 1
    ...
    template<template<typename...> class container_t> using handler_t = secdecutil::amplitude::WeightedIntegralHandler<integrand_return_t,real_t,integrand_return_t,container_t>;
            ...
            typedef secdecutil::CudaIntegrandContainerWithDeformation
                    <
                        ...
                        'd','o','u','b','l','e','b','o','x','_','p','l','a','n','a','r'
                    >
                    cuda_integrand_t;
...
{
    template <>
    struct common_type<doublebox_planar::cuda_together_integrand_t, doublebox_planar::cuda_integrand_t> 
    {
        using type = doublebox_planar::cuda_together_integrand_t;
    };
}
#endif
