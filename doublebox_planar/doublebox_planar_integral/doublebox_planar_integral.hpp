#ifndef doublebox_planar_integral_hpp_included
#define doublebox_planar_integral_hpp_included
...
namespace doublebox_planar_integral
{
    ...
    #define doublebox_planar_integral_has_complex_parameters 0

    // whether or not the return type should be complex in any case
    #define doublebox_planar_integral_enforce_complex_return_type 0
    ...
    #endif
    #if doublebox_planar_integral_has_complex_parameters || doublebox_planar_integral_contour_deformation || doublebox_planar_integral_enforce_complex_return_type
    ...
    const std::string package_name = "doublebox_planar_integral";
    ...
    //#undef doublebox_planar_integral_has_complex_parameters
    //#undef doublebox_planar_integral_enforce_complex_return_type
...
{
    template <>
    struct common_type<doublebox_planar_integral::cuda_together_integrand_t, doublebox_planar_integral::cuda_integrand_t> 
    {
        using type = doublebox_planar_integral::cuda_together_integrand_t;
    };
}
#endif
